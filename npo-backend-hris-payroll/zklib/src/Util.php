...
class Util
{
     ...
     * @return bool|number
     */
    static public function getSize($self)
    {
     ...
     * @return string
     */
    static public function recData($self, $maxErrors = 10, $first = true)
    {
        $data = '';
     ...
     * @param int $bytes
     */
    static private function logReceived($self, $received, $bytes)
    {
     ...
     * @param string $str
     */
    static private function logger($self, $str)
    {
