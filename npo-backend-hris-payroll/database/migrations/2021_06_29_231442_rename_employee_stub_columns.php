...
class RenameEmployeeStubColumns extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('employee_stub', function (Blueprint $table) {
            $table->renameColumn('loan', 'loans');
            $table->renameColumn('contribution', 'contributions');
            $table->renameColumn('reimbursement', 'reimbursements');
        });
    ...
    {
        Schema::table('employee_stub', function (Blueprint $table) {
            $table->renameColumn('loans', 'loan');
            $table->renameColumn('contributions', 'contribution');
            $table->renameColumn('reimbursements', 'reimbursement');
        });
        DB::statement($this->dropView());
    }
    ...
    private function createView(): string
    {
        return "CREATE OR REPLACE VIEW `list_employee_stub_view`
            AS SELECT DISTINCT
                ...
                `employee_stub`.`contributions`,
                `employee_stub`.`deductions`,
                `employee_stub`.`loans`,
                `employee_stub`.`reimbursements`,
