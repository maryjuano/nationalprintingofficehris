...
namespace Local\Zklib;

require(dirname(__DIR__, 1) . '/vendor/autoload.php');

use Local\Zklib\ZK\Util;
...
class ZKLib
{
  ...
  public function fetchAttendanceLogs()
  {
    $this->connect();
    $this->disableDevice();
    file_put_contents("zkteco_logs/attendance_logs_{$this->_ip}.json", json_encode($this->getAttendance()));
    $this->enableDevice();
    $this->disconnect();
  }
  ...
  public function fetchUsers()
  {
    $this->connect();
    $this->disableDevice();
    file_put_contents("zkteco_logs/users_{$this->_ip}.json", json_encode($this->getUser()));
    $this->enableDevice();
    $this->disconnect();
  }
}
