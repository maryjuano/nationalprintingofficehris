...
class ModifyEmployeStubListView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    private function createView(): string
    {
        return "CREATE OR REPLACE VIEW `list_employee_stub_view`
            ...
            LEFT JOIN `sections` ON `employment_and_compensation`.`section` = `sections`.`id`
            ...
            LEFT JOIN `employee_id_number` ON `employees`.`users_id` = `employee_id_number`.`users_id`
